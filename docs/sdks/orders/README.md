...
* [complete](#complete) - Completar pedido
* [cancel](#cancel) - Cancelar pedido
* [prepare](#prepare) - Preparar pedido
* [package](#package) - Empaquetar pedido
* [unprepare](#unprepare) - Revertir preparación del pedido
* [changeFulfillmentLocation](#changefulfillmentlocation) - Cambiar ubicación de preparación
* [unarchive](#unarchive) - Desarchivar pedido
* [listFulfillmentOrders](#listfulfillmentorders) - Listar órdenes de preparación del pedido
* [invoice](#invoice) - Facturar pedido
...
async function run() {
  const result = await lapyme.orders.complete({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersComplete } from "lapyme/funcs/orders-complete.js";
...
async function run() {
  const res = await ordersComplete(lapyme, {
    orderId: "241d9146-e431-4f6c-baa1-cc5041daa3bc",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("ordersComplete failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.prepare({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersPrepare } from "lapyme/funcs/orders-prepare.js";
...
async function run() {
  const res = await ordersPrepare(lapyme, {
    orderId: "4cf6dbdc-3139-4f1e-b983-7eeee6973c21",
    idempotencyKey: "<value>",
    body: {
      items: [
  ...
  if (res.ok) {
    ...
    console.log("ordersPrepare failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.package({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersPackage } from "lapyme/funcs/orders-package.js";
...
async function run() {
  const res = await ordersPackage(lapyme, {
    orderId: "2b0d3f96-6df9-4ab6-a57a-b33f95552dbe",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("ordersPackage failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.unprepare({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersUnprepare } from "lapyme/funcs/orders-unprepare.js";
...
async function run() {
  const res = await ordersUnprepare(lapyme, {
    orderId: "47b4982d-75f8-4739-87b6-4ecb820a257d",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("ordersUnprepare failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.changeFulfillmentLocation({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersChangeFulfillmentLocation } from "lapyme/funcs/orders-change-fulfillment-location.js";
...
async function run() {
  const res = await ordersChangeFulfillmentLocation(lapyme, {
    orderId: "92c5bb7f-533e-4658-b28b-eaa5a9b1a2b6",
    body: {
      warehouseId: "6bf3d383-0f30-4723-95e7-fca13c16dca2",
      items: [],
  ...
  if (res.ok) {
    ...
    console.log("ordersChangeFulfillmentLocation failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.listFulfillmentOrders({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersListFulfillmentOrders } from "lapyme/funcs/orders-list-fulfillment-orders.js";
...
async function run() {
  const res = await ordersListFulfillmentOrders(lapyme, {
    orderId: "5f05654d-e12d-4181-98c6-be7ca4749beb",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("ordersListFulfillmentOrders failed:", res.error);
  }
}
...
async function run() {
  const result = await lapyme.orders.invoice({
...
```typescript
import { LapymeCore } from "lapyme/core.js";
import { ordersInvoice } from "lapyme/funcs/orders-invoice.js";
...
async function run() {
  const res = await ordersInvoice(lapyme, {
    orderId: "62fba979-300a-4a3f-ba3d-8aa6af2a9a8a",
    idempotencyKey: "<value>",
    body: {
      voucherType: 48872,
