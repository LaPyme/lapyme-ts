...
* [listApiDeliveryNotes](#listapideliverynotes) - List delivery notes
* [createApiDeliveryNote](#createapideliverynote) - Create a delivery note
* [getApiDeliveryNoteById](#getapideliverynotebyid) - Get a delivery note
* [~~listApiRemitos~~](#listapiremitos) - Listar remitos :warning: **Deprecated**
* [~~getApiRemitoById~~](#getapiremitobyid) - Obtener remito por ID :warning: **Deprecated**
...
Lists delivery notes for the authenticated organization with stable cursor pagination and optional sale, customer, search, and date filters.
...
Returns the complete organization-scoped delivery note, including its origin, customer, point of sale, logistics metadata, and items.
