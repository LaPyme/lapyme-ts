...
```typescript
import { ApiCustomerCreateResponse } from "lapyme/models";

let value: ApiCustomerCreateResponse = {
  requestId: "<id>",
  data: {
    customer: {
      object: "customer",
...
| `data`                                                                                 | [models.ApiCustomerCreateResponseData](../models/api-customer-create-response-data.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |
