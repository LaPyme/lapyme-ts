...
| `dimensions`                                                                                                                        | [models.PurchasesReportRequestDimension](../models/purchases-report-request-dimension.md)[]                                         | :heavy_minus_sign:                                                                                                                  | Dimensiones de agrupación. Máximo 4.                                                                                                |
...
| `dimensionFilters`                                                                                                                  | [models.PurchasesReportRequestDimensionFilters](../models/purchases-report-request-dimension-filters.md)                            | :heavy_minus_sign:                                                                                                                  | Filtros por dimensión. Cada clave debe ser una dimensión filtrable para la fuente. El valor es un array de IDs o valores a incluir. |
