...
| `registerId`                                                                       | *string*                                                                           | :heavy_minus_sign:                                                                 | ID de caja para pagos en efectivo. Usá cash_source en integraciones nuevas.        |
| `safeId`                                                                           | *string*                                                                           | :heavy_minus_sign:                                                                 | ID de caja fuerte para pagos en efectivo. Usá cash_source en integraciones nuevas. |
| `cashSource`                                                                       | [models.ApiCashSourceRef](../models/api-cash-source-ref.md)                        | :heavy_minus_sign:                                                                 | N/A                                                                                |