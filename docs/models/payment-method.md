...
| `registerId`                                                                      | *string*                                                                          | :heavy_minus_sign:                                                                | ID de caja para pagos en efectivo. Usá cashSource en integraciones nuevas.        |
| `safeId`                                                                          | *string*                                                                          | :heavy_minus_sign:                                                                | ID de caja fuerte para pagos en efectivo. Usá cashSource en integraciones nuevas. |
| `cashSource`                                                                      | [models.CashSource](../models/cash-source.md)                                     | :heavy_minus_sign:                                                                | Origen de efectivo para pagos cash. No combinar con registerId o safeId.          |