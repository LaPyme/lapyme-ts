...
| `currency`                                                                                 | [models.ApiSharedEnumffb4886f2b](../../models/api-shared-enumffb4886f2b.md)                | :heavy_minus_sign:                                                                         | Obligatorio cuando se envía total_amount                                                   |
| `exchangeRate`                                                                             | *number*                                                                                   | :heavy_minus_sign:                                                                         | Pesos argentinos por dólar. Obligatorio solamente para currency=USD.                       |
