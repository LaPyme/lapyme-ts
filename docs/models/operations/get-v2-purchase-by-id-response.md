...
```typescript
import { GetV2PurchaseByIdResponse } from "lapyme/models/operations";

let value: GetV2PurchaseByIdResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                       | [models.V2PurchaseDetailResponse](../../models/v2-purchase-detail-response.md) | :heavy_check_mark:                                                             | N/A                                                                            |