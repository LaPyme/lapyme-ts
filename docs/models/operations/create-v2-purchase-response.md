...
```typescript
import { CreateV2PurchaseResponse } from "lapyme/models/operations";

let value: CreateV2PurchaseResponse = {
  headers: {},
  result: {
    requestId: "<id>",
    success: true,
...
| `result`                                      | *models.V2PurchaseTransactionSuccessResponse* | :heavy_check_mark:                            | N/A                                           |