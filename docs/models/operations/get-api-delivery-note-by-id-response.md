...
```typescript
import { GetApiDeliveryNoteByIdResponse } from "lapyme/models/operations";

let value: GetApiDeliveryNoteByIdResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                                  | [models.ApiDeliveryNoteDetailResponse](../../models/api-delivery-note-detail-response.md) | :heavy_check_mark:                                                                        | N/A                                                                                       |