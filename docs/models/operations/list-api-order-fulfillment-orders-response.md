...
```typescript
import { ListApiOrderFulfillmentOrdersResponse } from "lapyme/models/operations";

let value: ListApiOrderFulfillmentOrdersResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                                          | [models.ApiOrderFulfillmentOrdersResponse](../../models/api-order-fulfillment-orders-response.md) | :heavy_check_mark:                                                                                | N/A                                                                                               |