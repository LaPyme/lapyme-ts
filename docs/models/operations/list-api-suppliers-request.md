...
| `status`                                                                             | [models.ApiSharedEnumd952d5ce8e](../../models/api-shared-enumd952d5ce8e.md)[]        | :heavy_minus_sign:                                                                   | Estados exactos a incluir. Enviá ambos para incluir proveedores activos e inactivos. |