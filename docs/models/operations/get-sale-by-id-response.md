...
```typescript
import { GetSaleByIdResponse } from "lapyme/models/operations";

let value: GetSaleByIdResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                                      | [operations.GetSaleByIdResponseBody](../../models/operations/get-sale-by-id-response-body.md) | :heavy_check_mark:                                                                            | N/A                                                                                           |