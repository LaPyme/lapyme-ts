...
| `dateFrom`                                             | [Date](../../types/rfcdate.md)                         | :heavy_minus_sign:                                     | Fecha inicial del remito (inclusive)                   |
| `dateTo`                                               | [Date](../../types/rfcdate.md)                         | :heavy_minus_sign:                                     | Fecha final del remito (inclusive)                     |