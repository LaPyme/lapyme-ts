...
```typescript
import { GetCategoryByIdResponse } from "lapyme/models";
...
| `data`                                                                              | [models.GetCategoryByIdResponseData](../models/get-category-by-id-response-data.md) | :heavy_check_mark:                                                                  | N/A                                                                                 |