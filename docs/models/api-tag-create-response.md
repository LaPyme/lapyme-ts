...
```typescript
import { ApiTagCreateResponse } from "lapyme/models";

let value: ApiTagCreateResponse = {
  requestId: "<id>",
  data: {
    tag: {
      object: "tag",
...
| `data`                                                                       | [models.ApiTagCreateResponseData](../models/api-tag-create-response-data.md) | :heavy_check_mark:                                                           | N/A                                                                          |
