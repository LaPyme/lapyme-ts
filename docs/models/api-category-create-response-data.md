...
```typescript
import { ApiCategoryCreateResponseData } from "lapyme/models";

let value: ApiCategoryCreateResponseData = {
  category: {
    object: "category",
...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `category`                                                                                     | [models.ApiCategoryCreateResponseCategory](../models/api-category-create-response-category.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |
