...
```typescript
import { ApiProductUpdateResponse } from "lapyme/models";

let value: ApiProductUpdateResponse = {
  requestId: "<id>",
  data: {
    product: {
...
| `data`                                                                               | [models.ApiProductUpdateResponseData](../models/api-product-update-response-data.md) | :heavy_check_mark:                                                                   | N/A                                                                                  |
