...
| `status`                                                                                                                   | [models.ApiStockTransferSuccessResponseStatus](../models/api-stock-transfer-success-response-status.md)                    | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `createdAt`                                                                                                                | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                              | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `updatedAt`                                                                                                                | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                              | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `createdBy`                                                                                                                | *string*                                                                                                                   | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `updatedBy`                                                                                                                | *string*                                                                                                                   | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `sourceWarehouse`                                                                                                          | [models.ApiStockTransferSuccessResponseSourceWarehouse](../models/api-stock-transfer-success-response-source-warehouse.md) | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `targetWarehouse`                                                                                                          | [models.ApiStockTransferSuccessResponseTargetWarehouse](../models/api-stock-transfer-success-response-target-warehouse.md) | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `items`                                                                                                                    | [models.ApiStockTransferSuccessResponseItem](../models/api-stock-transfer-success-response-item.md)[]                      | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |