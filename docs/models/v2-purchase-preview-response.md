...
```typescript
import { V2PurchasePreviewResponse } from "lapyme/models";

let value: V2PurchasePreviewResponse = {
  requestId: "<id>",
  success: true,
  mode: "preview",
  data: {
...
| `mode`                                                                                                      | *"preview"*                                                                                                 | :heavy_check_mark:                                                                                          | N/A                                                                                                         |
| `data`                                                                                                      | [models.V2PurchasePreviewResponseData](../models/v2-purchase-preview-response-data.md)                      | :heavy_check_mark:                                                                                          | N/A                                                                                                         |
| `warnings`                                                                                                  | [models.V2PurchasePreviewResponseWarning](../models/v2-purchase-preview-response-warning.md)[]              | :heavy_check_mark:                                                                                          | N/A                                                                                                         |
| `blockingIssues`                                                                                            | [models.V2PurchasePreviewResponseBlockingIssue](../models/v2-purchase-preview-response-blocking-issue.md)[] | :heavy_check_mark:                                                                                          | N/A                                                                                                         |