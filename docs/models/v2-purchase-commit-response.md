...
```typescript
import { V2PurchaseCommitResponse } from "lapyme/models";

let value: V2PurchaseCommitResponse = {
  requestId: "<id>",
  success: true,
  mode: "commit",
  data: {
...
| `mode`                                                                                                    | *"commit"*                                                                                                | :heavy_check_mark:                                                                                        | N/A                                                                                                       |
| `data`                                                                                                    | [models.V2PurchaseCommitResponseData](../models/v2-purchase-commit-response-data.md)                      | :heavy_check_mark:                                                                                        | N/A                                                                                                       |
| `warnings`                                                                                                | [models.V2PurchaseCommitResponseWarning](../models/v2-purchase-commit-response-warning.md)[]              | :heavy_check_mark:                                                                                        | N/A                                                                                                       |
| `blockingIssues`                                                                                          | [models.V2PurchaseCommitResponseBlockingIssue](../models/v2-purchase-commit-response-blocking-issue.md)[] | :heavy_check_mark:                                                                                        | N/A                                                                                                       |