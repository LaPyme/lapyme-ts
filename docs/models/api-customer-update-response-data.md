...
```typescript
import { ApiCustomerUpdateResponseData } from "lapyme/models";

let value: ApiCustomerUpdateResponseData = {
  customer: {
    object: "customer",
    id: "627f8762-28e3-42d3-a7cd-648f9f1a8329",
    name: "<value>",
    companyName: "Crona and Sons",
    description: "drat secularize zany pacemaker after steep spectate toward",
...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `customer`                                                                                     | [models.ApiCustomerUpdateResponseCustomer](../models/api-customer-update-response-customer.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |