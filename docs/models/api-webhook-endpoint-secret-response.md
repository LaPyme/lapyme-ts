...
```typescript
import { ApiWebhookEndpointSecretResponse } from "lapyme/models";

let value: ApiWebhookEndpointSecretResponse = {
  requestId: "<id>",
  data: {
...
| `data`                                                                                                | [models.ApiWebhookEndpointSecretResponseData](../models/api-webhook-endpoint-secret-response-data.md) | :heavy_check_mark:                                                                                    | N/A                                                                                                   |