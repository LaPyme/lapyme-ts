...
```typescript
import { ApiTransferDetailResponse } from "lapyme/models";

let value: ApiTransferDetailResponse = {
  requestId: "<id>",
  data: {
...
| `data`                                                                       | [models.ApiSharedObjectb3072efb33](../models/api-shared-objectb3072efb33.md) | :heavy_check_mark:                                                           | N/A                                                                          |