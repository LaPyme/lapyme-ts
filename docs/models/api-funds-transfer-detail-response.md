...
```typescript
import { ApiFundsTransferDetailResponse } from "lapyme/models";

let value: ApiFundsTransferDetailResponse = {
  requestId: "<id>",
  data: {
...
| `data`                                                                                            | [models.ApiFundsTransferDetailResponseData](../models/api-funds-transfer-detail-response-data.md) | :heavy_check_mark:                                                                                | N/A                                                                                               |