...
export function categoriesGetById(
  ...
  Result<
    operations.GetApiCategoryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetApiCategoryRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiCategoryResponse$inboundSchema, {
      key: "Result",
    }),
