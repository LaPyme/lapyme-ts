 ...
 */
export function apiListAPICashSources(
  client: LapymeCore,
  request?: operations.ListApiCashSourcesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiCashSourcesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiCashSourcesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/cash-sources")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiCashSourcesResponse$inboundSchema, {
      key: "Result",
    }),
