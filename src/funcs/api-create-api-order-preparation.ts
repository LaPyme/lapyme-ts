...
export function apiCreateAPIOrderPreparation(
  ...
  Result<
    operations.CreateApiOrderPreparationResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiOrderPreparationRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/preparations")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiOrderPreparationResponse$inboundSchema, {
      key: "Result",
    }),
