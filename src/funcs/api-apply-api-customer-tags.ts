 ...
 */
export function apiApplyAPICustomerTags(
  client: LapymeCore,
  request: operations.ApplyApiCustomerTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplyApiCustomerTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApplyApiCustomerTagsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/customers/tags/apply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApplyApiCustomerTagsResponse$inboundSchema, {
      key: "Result",
    }),
