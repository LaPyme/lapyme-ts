 ...
 */
export function apiListAPISuppliers(
  client: LapymeCore,
  request?: operations.ListApiSuppliersRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiSuppliersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiSuppliersRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiSuppliersResponse$inboundSchema, {
      key: "Result",
    }),
