 ...
 */
export function supplierPaymentsListSupplierPayments(
  client: LapymeCore,
  request?: operations.ListApiSupplierPaymentsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiSupplierPaymentsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiSupplierPaymentsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiSupplierPaymentsResponse$inboundSchema, {
      key: "Result",
    }),
