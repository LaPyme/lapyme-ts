 ...
 */
export function priceListsGetPriceListById(
  client: LapymeCore,
  request: operations.GetApiPriceListByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiPriceListByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiPriceListByIdRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/price-lists/{price_list_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiPriceListByIdResponse$inboundSchema, {
      key: "Result",
    }),
