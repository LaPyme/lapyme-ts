 ...
 */
export function apiCreateAPIReturnCreditNote(
  client: LapymeCore,
  request: operations.CreateApiReturnCreditNoteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiReturnCreditNoteResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiReturnCreditNoteRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/sales/{sale_id}/returns")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiReturnCreditNoteResponse$inboundSchema, {
      key: "Result",
    }),
