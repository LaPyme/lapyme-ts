 ...
 */
export function apiCreateAPITag(
  client: LapymeCore,
  request: operations.CreateApiTagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiTagResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreateApiTagRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/tags")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiTagResponse$inboundSchema, {
      key: "Result",
    }),
