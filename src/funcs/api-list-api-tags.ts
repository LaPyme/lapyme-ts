 ...
 */
export function apiListAPITags(
  client: LapymeCore,
  request: operations.ListApiTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ListApiTagsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiTagsResponse$inboundSchema, {
      key: "Result",
    }),
