 ...
 */
export function apiUpdateAPICustomer(
  client: LapymeCore,
  request: operations.UpdateApiCustomerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiCustomerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiCustomerRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiCustomerResponse$inboundSchema, {
      key: "Result",
    }),
