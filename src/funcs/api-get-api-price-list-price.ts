 ...
 */
export function apiGetAPIPriceListPrice(
  client: LapymeCore,
  request: operations.GetApiPriceListPriceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiPriceListPriceResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiPriceListPriceRequest$outboundSchema, value),
  ...
  >(
    M.json(
      200,
      types$.optional(operations.GetApiPriceListPriceResponse$inboundSchema),
