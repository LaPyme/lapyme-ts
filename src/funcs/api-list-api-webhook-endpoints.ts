 ...
 */
export function apiListAPIWebhookEndpoints(
  client: LapymeCore,
  request?: operations.ListApiWebhookEndpointsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiWebhookEndpointsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiWebhookEndpointsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiWebhookEndpointsResponse$inboundSchema, {
      key: "Result",
    }),
