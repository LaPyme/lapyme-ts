 ...
 */
export function inventoryListInventoryMovements(
  client: LapymeCore,
  request: operations.ListApiInventoryMovementsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiInventoryMovementsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListApiInventoryMovementsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/inventory/movements")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiInventoryMovementsResponse$inboundSchema, {
      key: "Result",
    }),
