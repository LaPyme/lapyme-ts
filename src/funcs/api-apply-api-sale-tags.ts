 ...
 */
export function apiApplyAPISaleTags(
  client: LapymeCore,
  request: operations.ApplyApiSaleTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplyApiSaleTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApplyApiSaleTagsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/sales/tags/apply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApplyApiSaleTagsResponse$inboundSchema, {
      key: "Result",
    }),
