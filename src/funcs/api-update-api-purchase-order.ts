 ...
 */
export function apiUpdateAPIPurchaseOrder(
  client: LapymeCore,
  request: operations.UpdateApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
