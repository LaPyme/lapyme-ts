...
export function apiCreateAPIInflationAdjustment(
  ...
  Result<
    operations.CreateApiInflationAdjustmentResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiInflationAdjustmentRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/inflation-adjustments")();
