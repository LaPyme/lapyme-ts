 ...
 */
export function salesPatchMetadata(
  client: LapymeCore,
  request: operations.PatchApiSaleMetadataRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchApiSaleMetadataResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PatchApiSaleMetadataRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchApiSaleMetadataResponse$inboundSchema, {
      key: "Result",
    }),
