 ...
 */
export function apiCreateAPISupplier(
  client: LapymeCore,
  request: operations.CreateApiSupplierRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiSupplierResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiSupplierRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/suppliers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiSupplierResponse$inboundSchema, {
      key: "Result",
    }),
