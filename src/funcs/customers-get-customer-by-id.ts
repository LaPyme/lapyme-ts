 ...
 */
export function customersGetCustomerById(
  client: LapymeCore,
  request: operations.GetApiCustomerByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiCustomerByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiCustomerByIdRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/customers/{customer_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiCustomerByIdResponse$inboundSchema, {
      key: "Result",
    }),
