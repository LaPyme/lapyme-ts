 ...
 */
export function apiCloseAPIPurchaseOrder(
  client: LapymeCore,
  request: operations.CloseApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CloseApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CloseApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchase-orders/{purchase_order_id}/close")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CloseApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
