 ...
 */
export function customerPaymentsListCustomerPayments(
  client: LapymeCore,
  request?: operations.ListApiCustomerPaymentsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiCustomerPaymentsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiCustomerPaymentsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiCustomerPaymentsResponse$inboundSchema, {
      key: "Result",
    }),
