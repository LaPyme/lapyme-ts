 ...
 */
export function apiListAPIWebhookEventTypes(
  client: LapymeCore,
  request?: operations.ListApiWebhookEventTypesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiWebhookEventTypesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiWebhookEventTypesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/webhook-event-types")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiWebhookEventTypesResponse$inboundSchema, {
      key: "Result",
    }),
