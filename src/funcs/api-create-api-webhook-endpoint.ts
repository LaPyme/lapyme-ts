 ...
 */
export function apiCreateAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.CreateApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiWebhookEndpointRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/webhook-endpoints")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
