 ...
 */
export function apiCreateAPIManualJournalEntry(
  client: LapymeCore,
  request: operations.CreateApiManualJournalEntryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiManualJournalEntryResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiManualJournalEntryRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateApiManualJournalEntryResponse$inboundSchema, {
      key: "Result",
    }),
