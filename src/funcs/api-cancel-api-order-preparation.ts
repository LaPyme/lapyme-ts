...
export function apiCancelAPIOrderPreparation(
  ...
  Result<
    operations.CancelApiOrderPreparationResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CancelApiOrderPreparationRequest$outboundSchema,
        value,
      ),
  ...
  const pathParams = {
    ...
    preparation_id: encodeSimple("preparation_id", payload.preparation_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CancelApiOrderPreparationResponse$inboundSchema, {
      key: "Result",
    }),
