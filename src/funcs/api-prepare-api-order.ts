 ...
 */
export function apiPrepareAPIOrder(
  client: LapymeCore,
  request: operations.PrepareApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PrepareApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PrepareApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/prepare")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PrepareApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
