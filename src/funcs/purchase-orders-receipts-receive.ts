 ...
 */
export function purchaseOrdersReceiptsReceive(
  client: LapymeCore,
  request: operations.ReceiveApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ReceiveApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ReceiveApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReceiveApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
