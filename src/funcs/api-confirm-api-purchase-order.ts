 ...
 */
export function apiConfirmAPIPurchaseOrder(
  client: LapymeCore,
  request: operations.ConfirmApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ConfirmApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ConfirmApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConfirmApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
