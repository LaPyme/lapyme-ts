 ...
 */
export function apiGetAPIPaymentMethod(
  client: LapymeCore,
  request: operations.GetApiPaymentMethodRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiPaymentMethodResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiPaymentMethodRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiPaymentMethodResponse$inboundSchema, {
      key: "Result",
    }),
