 ...
 */
export function apiTestAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.TestApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TestApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.TestApiWebhookEndpointRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.TestApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
