...
export function getSaleById(
  ...
  Result<
    operations.GetSaleByIdResponse,
    | errors.GetSaleByIdNotFoundError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetSaleByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSaleByIdResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(404, errors.GetSaleByIdNotFoundError$inboundSchema),
