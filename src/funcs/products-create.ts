...
export function productsCreate(
  ...
  Result<
    operations.CreateApiProductResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiProductRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiProductResponse$inboundSchema, {
      key: "Result",
    }),
