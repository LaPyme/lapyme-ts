 ...
 */
export function apiUpdateAPIAccountingAccount(
  client: LapymeCore,
  request: operations.UpdateApiAccountingAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiAccountingAccountResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateApiAccountingAccountRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiAccountingAccountResponse$inboundSchema, {
      key: "Result",
    }),
