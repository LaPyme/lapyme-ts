 ...
 */
export function apiUpdateAPIProduct(
  client: LapymeCore,
  request: operations.UpdateApiProductRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiProductResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiProductRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiProductResponse$inboundSchema, {
      key: "Result",
    }),
