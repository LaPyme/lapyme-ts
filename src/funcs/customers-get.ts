...
export function customersGet(
  ...
  Result<
    operations.ListApiCustomersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiCustomersRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiCustomersResponse$inboundSchema, {
      key: "Result",
    }),
