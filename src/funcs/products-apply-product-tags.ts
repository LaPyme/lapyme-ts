 ...
 */
export function productsApplyProductTags(
  client: LapymeCore,
  request: operations.ApplyApiProductTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplyApiProductTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApplyApiProductTagsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/products/tags/apply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApplyApiProductTagsResponse$inboundSchema, {
      key: "Result",
    }),
