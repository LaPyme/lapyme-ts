...
export function apiUpdateAPIManualJournalEntry(
  ...
  Result<
    operations.UpdateApiManualJournalEntryResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateApiManualJournalEntryRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiManualJournalEntryResponse$inboundSchema, {
      key: "Result",
    }),
