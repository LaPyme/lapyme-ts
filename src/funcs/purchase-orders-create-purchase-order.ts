 ...
 */
export function purchaseOrdersCreatePurchaseOrder(
  client: LapymeCore,
  request: operations.CreateApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchase-orders")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
