...
export function customersCreate(
  ...
  Result<
    operations.CreateApiCustomerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiCustomerRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiCustomerResponse$inboundSchema, {
      key: "Result",
    }),
