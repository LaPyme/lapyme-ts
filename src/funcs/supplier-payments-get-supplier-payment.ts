 ...
 */
export function supplierPaymentsGetSupplierPayment(
  client: LapymeCore,
  request: operations.GetApiSupplierPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiSupplierPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiSupplierPaymentRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiSupplierPaymentResponse$inboundSchema, {
      key: "Result",
    }),
