 ...
 */
export function apiGetAPIBankAccount(
  client: LapymeCore,
  request: operations.GetApiBankAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiBankAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiBankAccountRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/bank-accounts/{bank_account_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiBankAccountResponse$inboundSchema, {
      key: "Result",
    }),
