 ...
 */
export function apiDeleteAPIPriceList(
  client: LapymeCore,
  request: operations.DeleteApiPriceListRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiPriceListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteApiPriceListRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiPriceListResponse$inboundSchema, {
      key: "Result",
    }),
