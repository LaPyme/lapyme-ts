 ...
 */
export function apiPatchAPIProductMetafields(
  client: LapymeCore,
  request: operations.PatchApiProductMetafieldsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchApiProductMetafieldsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PatchApiProductMetafieldsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/products/{product_id}/metafields")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchApiProductMetafieldsResponse$inboundSchema, {
      key: "Result",
    }),
