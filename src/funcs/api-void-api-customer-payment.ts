 ...
 */
export function apiVoidAPICustomerPayment(
  client: LapymeCore,
  request: operations.VoidApiCustomerPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VoidApiCustomerPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.VoidApiCustomerPaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/customer-payments/{payment_id}/void")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VoidApiCustomerPaymentResponse$inboundSchema, {
      key: "Result",
    }),
