 ...
 * Desarchivar pedido
 */
export function apiUnarchiveAPIOrder(
  client: LapymeCore,
  request: operations.UnarchiveApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UnarchiveApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UnarchiveApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/unarchive")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UnarchiveApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
