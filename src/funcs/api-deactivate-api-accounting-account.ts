 ...
 */
export function apiDeactivateAPIAccountingAccount(
  client: LapymeCore,
  request: operations.DeactivateApiAccountingAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeactivateApiAccountingAccountResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeactivateApiAccountingAccountRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/accounts/{account_id}")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.DeactivateApiAccountingAccountResponse$inboundSchema,
      { key: "Result" },
    ),
