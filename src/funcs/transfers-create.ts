...
export function transfersCreate(
  ...
  Result<
    ...
    | errors.CreateTransferBadRequestError
    | errors.CreateTransferNotFoundError
    | errors.RateLimitedError1
    | LapymeError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateTransferRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/transfers")();
  ...
  >(
    ...
    M.jsonErr(400, errors.CreateTransferBadRequestError$inboundSchema),
    M.jsonErr(404, errors.CreateTransferNotFoundError$inboundSchema),
    M.jsonErr(429, errors.RateLimitedError1$inboundSchema, { hdrs: true }),
    M.fail("4XX"),
    M.fail("5XX"),
