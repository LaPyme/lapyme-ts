 ...
 */
export function purchaseOrdersListPurchaseOrders(
  client: LapymeCore,
  request?: operations.ListApiPurchaseOrdersRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiPurchaseOrdersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiPurchaseOrdersRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiPurchaseOrdersResponse$inboundSchema, {
      key: "Result",
    }),
