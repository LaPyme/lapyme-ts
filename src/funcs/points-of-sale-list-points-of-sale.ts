 ...
 */
export function pointsOfSaleListPointsOfSale(
  client: LapymeCore,
  request?: operations.ListApiPointsOfSaleRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiPointsOfSaleResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiPointsOfSaleRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/points-of-sale")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiPointsOfSaleResponse$inboundSchema, {
      key: "Result",
    }),
