 ...
 */
export function apiListAPIAccountingAccounts(
  client: LapymeCore,
  request?: operations.ListApiAccountingAccountsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiAccountingAccountsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiAccountingAccountsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/accounts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiAccountingAccountsResponse$inboundSchema, {
      key: "Result",
    }),
