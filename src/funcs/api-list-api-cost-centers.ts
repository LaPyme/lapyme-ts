 ...
 */
export function apiListAPICostCenters(
  client: LapymeCore,
  request?: operations.ListApiCostCentersRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiCostCentersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiCostCentersRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/cost-centers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiCostCentersResponse$inboundSchema, {
      key: "Result",
    }),
