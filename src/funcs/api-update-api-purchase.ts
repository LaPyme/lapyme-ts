 ...
 */
export function apiUpdateAPIPurchase(
  client: LapymeCore,
  request: operations.UpdateApiPurchaseRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiPurchaseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiPurchaseRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchases/{purchase_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiPurchaseResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr([400, 401, 403, 404, 412], errors.ApiErrorEnvelope$inboundSchema),
