 ...
 * Cancelar pedido
 */
export function apiCancelAPIOrder(
  client: LapymeCore,
  request: operations.CancelApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CancelApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CancelApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/cancel")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CancelApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
