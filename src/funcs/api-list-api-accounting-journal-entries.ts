 ...
 */
export function apiListAPIAccountingJournalEntries(
  client: LapymeCore,
  request?: operations.ListApiAccountingJournalEntriesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiAccountingJournalEntriesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListApiAccountingJournalEntriesRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/journal-entries")();
  ...
  >(
    M.json(
      200,
      operations.ListApiAccountingJournalEntriesResponse$inboundSchema,
      { key: "Result" },
    ),
