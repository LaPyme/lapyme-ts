 ...
 */
export function apiUpdateAPISupplier(
  client: LapymeCore,
  request: operations.UpdateApiSupplierRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiSupplierResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiSupplierRequest$outboundSchema, value),
