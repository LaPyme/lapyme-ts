 ...
 */
export function stockTransfersListStockTransfers(
  client: LapymeCore,
  request?: operations.ListApiStockTransfersRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiStockTransfersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiStockTransfersRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiStockTransfersResponse$inboundSchema, {
      key: "Result",
    }),
