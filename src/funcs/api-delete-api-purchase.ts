 ...
 */
export function apiDeleteAPIPurchase(
  client: LapymeCore,
  request: operations.DeleteApiPurchaseRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiPurchaseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteApiPurchaseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiPurchaseResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
