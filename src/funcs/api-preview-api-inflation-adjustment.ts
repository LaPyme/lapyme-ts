...
export function apiPreviewAPIInflationAdjustment(
  ...
  Result<
    operations.PreviewApiInflationAdjustmentResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        models.ApiInflationAdjustmentPreviewRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/inflation-adjustments/preview")();
  ...
  >(
    M.json(
      200,
      operations.PreviewApiInflationAdjustmentResponse$inboundSchema,
      { key: "Result" },
    ),
