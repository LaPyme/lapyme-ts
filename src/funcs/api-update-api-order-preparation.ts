...
export function apiUpdateAPIOrderPreparation(
  ...
  Result<
    operations.UpdateApiOrderPreparationResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateApiOrderPreparationRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/preparation")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiOrderPreparationResponse$inboundSchema, {
      key: "Result",
    }),
