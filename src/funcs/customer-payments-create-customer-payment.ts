 ...
 */
export function customerPaymentsCreateCustomerPayment(
  client: LapymeCore,
  request: operations.CreateApiCustomerPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiCustomerPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiCustomerPaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/customer-payments")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiCustomerPaymentResponse$inboundSchema, {
      key: "Result",
    }),
