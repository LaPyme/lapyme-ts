 ...
 */
export function apiGetAPIIncomeStatementByCostCenter(
  client: LapymeCore,
  request?: operations.GetApiIncomeStatementByCostCenterRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiIncomeStatementByCostCenterResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.GetApiIncomeStatementByCostCenterRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const query = encodeFormQuery({
    ...
    "group_by_cost_center_position": payload?.group_by_cost_center_position,
  });
  ...
  >(
    M.json(
      200,
      operations.GetApiIncomeStatementByCostCenterResponse$inboundSchema,
      { key: "Result" },
    ),
