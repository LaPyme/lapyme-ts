 ...
 */
export function apiDeleteAPIArchivedOrder(
  client: LapymeCore,
  request: operations.DeleteApiArchivedOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiArchivedOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteApiArchivedOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiArchivedOrderResponse$inboundSchema, {
      key: "Result",
    }),
