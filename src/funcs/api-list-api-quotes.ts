 ...
 */
export function apiListAPIQuotes(
  client: LapymeCore,
  request?: operations.ListApiQuotesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiQuotesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiQuotesRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiQuotesResponse$inboundSchema, {
      key: "Result",
    }),
