 ...
 */
export function apiDeleteAPIManualJournalEntry(
  client: LapymeCore,
  request: operations.DeleteApiManualJournalEntryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiManualJournalEntryResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteApiManualJournalEntryRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiManualJournalEntryResponse$inboundSchema, {
      key: "Result",
    }),
