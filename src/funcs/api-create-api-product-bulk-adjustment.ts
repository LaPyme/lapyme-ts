 ...
 */
export function apiCreateAPIProductBulkAdjustment(
  client: LapymeCore,
  request: operations.CreateApiProductBulkAdjustmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiProductBulkAdjustmentResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiProductBulkAdjustmentRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/products/bulk-adjustments")();
  ...
  >(
    M.json(
      200,
      operations.CreateApiProductBulkAdjustmentResponse$inboundSchema,
      { key: "Result" },
    ),
