 ...
 */
export function apiRotateSecretAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.RotateSecretApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RotateSecretApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.RotateSecretApiWebhookEndpointRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.RotateSecretApiWebhookEndpointResponse$inboundSchema,
      { key: "Result" },
    ),
