 ...
 */
export function apiGetAPIAccountingJournalEntry(
  client: LapymeCore,
  request: operations.GetApiAccountingJournalEntryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiAccountingJournalEntryResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetApiAccountingJournalEntryRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiAccountingJournalEntryResponse$inboundSchema, {
      key: "Result",
    }),
