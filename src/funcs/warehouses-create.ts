 ...
 */
export function warehousesCreate(
  client: LapymeCore,
  request: operations.CreateApiWarehouseRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiWarehouseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiWarehouseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiWarehouseResponse$inboundSchema, {
      key: "Result",
    }),
