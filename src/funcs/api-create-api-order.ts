 ...
 */
export function apiCreateAPIOrder(
  client: LapymeCore,
  request: operations.CreateApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreateApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
