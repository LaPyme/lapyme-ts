...
export function apiArchiveAPIOrder(
  ...
  Result<
    operations.ArchiveApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ArchiveApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/archive")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ArchiveApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
