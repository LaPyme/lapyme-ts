 ...
 */
export function apiUpdateAPISupplierPayment(
  client: LapymeCore,
  request: operations.UpdateApiSupplierPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiSupplierPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiSupplierPaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/supplier-payments/{payment_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiSupplierPaymentResponse$inboundSchema, {
      key: "Result",
    }),
