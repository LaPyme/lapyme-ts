...
export function apiListAPICostCenterDimensions(
  ...
  Result<
    operations.ListApiCostCenterDimensionsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListApiCostCenterDimensionsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/cost-center-dimensions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiCostCenterDimensionsResponse$inboundSchema, {
      key: "Result",
    }),
