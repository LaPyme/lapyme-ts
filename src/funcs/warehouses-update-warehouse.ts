 ...
 */
export function warehousesUpdateWarehouse(
  client: LapymeCore,
  request: operations.UpdateApiWarehouseRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiWarehouseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiWarehouseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiWarehouseResponse$inboundSchema, {
      key: "Result",
    }),
