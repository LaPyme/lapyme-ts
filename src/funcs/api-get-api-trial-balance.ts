 ...
 */
export function apiGetAPITrialBalance(
  client: LapymeCore,
  request?: operations.GetApiTrialBalanceRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiTrialBalanceResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetApiTrialBalanceRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/trial-balance")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiTrialBalanceResponse$inboundSchema, {
      key: "Result",
    }),
