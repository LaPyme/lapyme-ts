 ...
 */
export function purchasesApplyPurchaseTags(
  client: LapymeCore,
  request: operations.ApplyApiPurchaseTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplyApiPurchaseTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApplyApiPurchaseTagsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchases/tags/apply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApplyApiPurchaseTagsResponse$inboundSchema, {
      key: "Result",
    }),
