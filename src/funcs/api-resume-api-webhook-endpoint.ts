 ...
 */
export function apiResumeAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.ResumeApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ResumeApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ResumeApiWebhookEndpointRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResumeApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
