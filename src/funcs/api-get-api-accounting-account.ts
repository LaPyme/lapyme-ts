...
export function apiGetAPIAccountingAccount(
  ...
  Result<
    operations.GetApiAccountingAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiAccountingAccountRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiAccountingAccountResponse$inboundSchema, {
      key: "Result",
    }),
