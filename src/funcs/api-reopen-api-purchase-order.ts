 ...
 */
export function apiReopenAPIPurchaseOrder(
  client: LapymeCore,
  request: operations.ReopenApiPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ReopenApiPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ReopenApiPurchaseOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchase-orders/{purchase_order_id}/reopen")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReopenApiPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
