 ...
 */
export function apiCreateAPIStandaloneCreditNote(
  client: LapymeCore,
  request: operations.CreateApiStandaloneCreditNoteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiStandaloneCreditNoteResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiStandaloneCreditNoteRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/credit-notes")();
  ...
  >(
    M.json(
      200,
      operations.CreateApiStandaloneCreditNoteResponse$inboundSchema,
      { key: "Result" },
    ),
