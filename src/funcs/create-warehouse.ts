...
export function createWarehouse(
  ...
  Result<
    operations.CreateWarehouseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateWarehouseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateWarehouseResponse$inboundSchema, {
      key: "Result",
    }),
