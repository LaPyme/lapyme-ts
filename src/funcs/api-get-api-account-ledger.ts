 ...
 */
export function apiGetAPIAccountLedger(
  client: LapymeCore,
  request: operations.GetApiAccountLedgerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiAccountLedgerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiAccountLedgerRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/accounting/accounts/{account_id}/ledger")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiAccountLedgerResponse$inboundSchema, {
      key: "Result",
    }),
