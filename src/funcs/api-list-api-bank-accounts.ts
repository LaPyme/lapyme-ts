 ...
 */
export function apiListAPIBankAccounts(
  client: LapymeCore,
  request?: operations.ListApiBankAccountsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiBankAccountsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiBankAccountsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/bank-accounts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiBankAccountsResponse$inboundSchema, {
      key: "Result",
    }),
