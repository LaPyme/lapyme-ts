...
export function apiListAPISummarizedJournal(
  ...
  Result<
    operations.ListApiSummarizedJournalResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiSummarizedJournalRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiSummarizedJournalResponse$inboundSchema, {
      key: "Result",
    }),
