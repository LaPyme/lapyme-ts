 ...
 */
export function apiGetAPIComparativeIncomeStatement(
  client: LapymeCore,
  request?: operations.GetApiComparativeIncomeStatementRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiComparativeIncomeStatementResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.GetApiComparativeIncomeStatementRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/accounting/income-statement/comparative")();
  ...
  >(
    M.json(
      200,
      operations.GetApiComparativeIncomeStatementResponse$inboundSchema,
      { key: "Result" },
    ),
