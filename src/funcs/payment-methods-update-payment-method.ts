 ...
 */
export function paymentMethodsUpdatePaymentMethod(
  client: LapymeCore,
  request: operations.UpdateApiPaymentMethodRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiPaymentMethodResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiPaymentMethodRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/payment-methods/{payment_method_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiPaymentMethodResponse$inboundSchema, {
      key: "Result",
    }),
