 ...
 */
export function apiQueryAPIReport(
  client: LapymeCore,
  request: models.ReportRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.QueryApiReportResponse,
...
> {
  ...
  const path = pathToFunc("/api/v1/reports/query")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.QueryApiReportResponse$inboundSchema, {
      key: "Result",
    }),
