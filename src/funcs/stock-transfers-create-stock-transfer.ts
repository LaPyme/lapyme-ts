 ...
 */
export function stockTransfersCreateStockTransfer(
  client: LapymeCore,
  request: operations.CreateApiStockTransferRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiStockTransferResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiStockTransferRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/stock-transfers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiStockTransferResponse$inboundSchema, {
      key: "Result",
    }),
