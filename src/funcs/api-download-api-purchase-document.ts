 ...
 */
export function apiDownloadAPIPurchaseDocument(
  client: LapymeCore,
  request: operations.DownloadApiPurchaseDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DownloadApiPurchaseDocumentResponse | undefined,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DownloadApiPurchaseDocumentRequest$outboundSchema,
        value,
      ),
  ...
  const pathParams = {
    purchase_id: encodeSimple("purchase_id", payload.purchase_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/api/v1/purchases/{purchase_id}/document")(
    pathParams,
  );
  ...
  >(
    M.nil(
      302,
      types$.optional(
        operations.DownloadApiPurchaseDocumentResponse$inboundSchema,
      ),
      { hdrs: true },
    ),
