 ...
 */
export function priceListsCreatePriceList(
  client: LapymeCore,
  request: operations.CreateApiPriceListRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiPriceListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiPriceListRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiPriceListResponse$inboundSchema, {
      key: "Result",
    }),
