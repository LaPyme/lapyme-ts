...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetCustomersRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/api/v1/customers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCustomersResponse$inboundSchema, {
      key: "Result",
    }),
