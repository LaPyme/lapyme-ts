 ...
 */
export function purchasesListPurchases(
  client: LapymeCore,
  request?: operations.ListApiPurchasesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiPurchasesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiPurchasesRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiPurchasesResponse$inboundSchema, {
      key: "Result",
    }),
