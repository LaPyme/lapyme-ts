 ...
 */
export function apiListAPIOrders(
  client: LapymeCore,
  request?: operations.ListApiOrdersRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiOrdersResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiOrdersRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiOrdersResponse$inboundSchema, {
      key: "Result",
    }),
