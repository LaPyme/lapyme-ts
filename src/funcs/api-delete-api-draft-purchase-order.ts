 ...
 */
export function apiDeleteAPIDraftPurchaseOrder(
  client: LapymeCore,
  request: operations.DeleteApiDraftPurchaseOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteApiDraftPurchaseOrderResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteApiDraftPurchaseOrderRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteApiDraftPurchaseOrderResponse$inboundSchema, {
      key: "Result",
    }),
