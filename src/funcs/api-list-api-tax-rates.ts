 ...
 */
export function apiListAPITaxRates(
  client: LapymeCore,
  request?: operations.ListApiTaxRatesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiTaxRatesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListApiTaxRatesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/tax-rates")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListApiTaxRatesResponse$inboundSchema, {
      key: "Result",
    }),
