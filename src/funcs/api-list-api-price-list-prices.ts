 ...
 */
export function apiListAPIPriceListPrices(
  client: LapymeCore,
  request: operations.ListApiPriceListPricesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListApiPriceListPricesResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListApiPriceListPricesRequest$outboundSchema, value),
  ...
  const pathParams = {
    price_list_id: encodeSimple("price_list_id", payload.price_list_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/api/v1/price-lists/{price_list_id}/prices")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      types$.optional(operations.ListApiPriceListPricesResponse$inboundSchema),
