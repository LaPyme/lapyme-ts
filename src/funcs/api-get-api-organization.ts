 ...
 */
export function apiGetAPIOrganization(
  client: LapymeCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiOrganizationResponse,
...
> {
  const path = pathToFunc("/api/v1/organization")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiOrganizationResponse$inboundSchema, {
      key: "Result",
    }),
