 ...
 */
export function apiInvoiceAPIOrder(
  client: LapymeCore,
  request: operations.InvoiceApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.InvoiceApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.InvoiceApiOrderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/orders/{order_id}/invoice")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.InvoiceApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
