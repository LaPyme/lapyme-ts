 ...
 */
export function apiUpdateAPIPriceList(
  client: LapymeCore,
  request: operations.UpdateApiPriceListRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateApiPriceListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateApiPriceListRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateApiPriceListResponse$inboundSchema, {
      key: "Result",
    }),
