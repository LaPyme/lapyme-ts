 ...
 */
export function apiDisableAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.DisableApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DisableApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DisableApiWebhookEndpointRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DisableApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
