 ...
 */
export function apiPatchAPIOrder(
  client: LapymeCore,
  request: operations.PatchApiOrderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchApiOrderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PatchApiOrderRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchApiOrderResponse$inboundSchema, {
      key: "Result",
    }),
