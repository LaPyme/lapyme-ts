 ...
 */
export function supplierPaymentsCreateSupplierPayment(
  client: LapymeCore,
  request: operations.CreateApiSupplierPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiSupplierPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiSupplierPaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/supplier-payments")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiSupplierPaymentResponse$inboundSchema, {
      key: "Result",
    }),
