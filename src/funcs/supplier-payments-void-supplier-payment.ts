 ...
 */
export function supplierPaymentsVoidSupplierPayment(
  client: LapymeCore,
  request: operations.VoidApiSupplierPaymentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VoidApiSupplierPaymentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.VoidApiSupplierPaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/supplier-payments/{payment_id}/void")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VoidApiSupplierPaymentResponse$inboundSchema, {
      key: "Result",
    }),
