 ...
 */
export function apiGetAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.GetApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiWebhookEndpointRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
