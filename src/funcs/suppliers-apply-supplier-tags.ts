 ...
 */
export function suppliersApplySupplierTags(
  client: LapymeCore,
  request: operations.ApplyApiSupplierTagsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ApplyApiSupplierTagsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApplyApiSupplierTagsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/suppliers/tags/apply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApplyApiSupplierTagsResponse$inboundSchema, {
      key: "Result",
    }),
