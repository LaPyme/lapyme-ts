 ...
 */
export function apiCreateAPIAccountingAccount(
  client: LapymeCore,
  request: operations.CreateApiAccountingAccountRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiAccountingAccountResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateApiAccountingAccountRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      [200, 201],
      operations.CreateApiAccountingAccountResponse$inboundSchema,
      { key: "Result" },
    ),
