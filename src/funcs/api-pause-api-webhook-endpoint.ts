 ...
 */
export function apiPauseAPIWebhookEndpoint(
  client: LapymeCore,
  request: operations.PauseApiWebhookEndpointRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PauseApiWebhookEndpointResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PauseApiWebhookEndpointRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PauseApiWebhookEndpointResponse$inboundSchema, {
      key: "Result",
    }),
