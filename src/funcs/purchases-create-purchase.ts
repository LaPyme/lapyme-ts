 ...
 */
export function purchasesCreatePurchase(
  client: LapymeCore,
  request: operations.CreateApiPurchaseRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateApiPurchaseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateApiPurchaseRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/purchases")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateApiPurchaseResponse$inboundSchema, {
      key: "Result",
    }),
