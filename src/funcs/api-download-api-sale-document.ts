 ...
 */
export function apiDownloadAPISaleDocument(
  client: LapymeCore,
  request: operations.DownloadApiSaleDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DownloadApiSaleDocumentResponse | undefined,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DownloadApiSaleDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/sales/{sale_id}/document")(pathParams);
  ...
  >(
    M.nil(
      302,
      types$.optional(operations.DownloadApiSaleDocumentResponse$inboundSchema),
      { hdrs: true },
    ),
    M.jsonErr([400, 401, 403, 404], errors.ApiErrorEnvelope$inboundSchema),
    M.jsonErr([409, 429], errors.ApiErrorEnvelope$inboundSchema, {
      hdrs: true,
    }),
