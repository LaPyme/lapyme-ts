 ...
 */
export function productsGetProductById(
  client: LapymeCore,
  request: operations.GetApiProductByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiProductByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetApiProductByIdRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/products/{product_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiProductByIdResponse$inboundSchema, {
      key: "Result",
    }),
