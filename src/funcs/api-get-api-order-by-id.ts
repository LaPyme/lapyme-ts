 ...
 */
export function apiGetAPIOrderById(
  client: LapymeCore,
  request: operations.GetApiOrderByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetApiOrderByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetApiOrderByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiOrderByIdResponse$inboundSchema, {
      key: "Result",
    }),
