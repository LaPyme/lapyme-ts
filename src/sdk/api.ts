...
import { apiGetAPIPriceListPrice } from "../funcs/api-get-api-price-list-price.js";
...
import { apiGetAPIReportCatalog } from "../funcs/api-get-api-report-catalog.js";
...
import { apiListAPIPriceListPrices } from "../funcs/api-list-api-price-list-prices.js";
...
import { apiListAPIReferenceCandidates } from "../funcs/api-list-api-reference-candidates.js";
...
export class Api extends ClientSDK {
   ...
   */
  async listApiPriceListPrices(
    request: operations.ListApiPriceListPricesRequest,
    options?: RequestOptions,
  ): Promise<operations.ListApiPriceListPricesResponse | undefined> {
    return unwrapAsync(apiListAPIPriceListPrices(
      this,
      request,
      options,
    ));
   ...
   */
  async getApiPriceListPrice(
    request: operations.GetApiPriceListPriceRequest,
    options?: RequestOptions,
  ): Promise<operations.GetApiPriceListPriceResponse | undefined> {
    return unwrapAsync(apiGetAPIPriceListPrice(
      this,
      request,
      options,
    ));
  ...
  /**
   * Listar candidatos de referencia
   *
   * @remarks
   ...
   */
  async listApiReferenceCandidates(
    request: operations.ListApiReferenceCandidatesRequest,
    options?: RequestOptions,
  ): Promise<models.ApiReferenceCandidateListResponse> {
    return unwrapAsync(apiListAPIReferenceCandidates(
      this,
      request,
      options,
    ));
  ...
  /**
   * Consultar catálogo de reportes
   *
   * @remarks
   ...
   */
  async getApiReportCatalog(
    options?: RequestOptions,
  ): Promise<models.ApiReportCatalogResponse> {
    return unwrapAsync(apiGetAPIReportCatalog(
      this,
      options,
    ));
  }
