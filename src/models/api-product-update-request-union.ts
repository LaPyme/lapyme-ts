...
export type ApiProductUpdateRequestUnion =
  | ApiSharedObjectfa4f19d7d0
...
/** @internal */
export type ApiProductUpdateRequestUnion$Outbound =
  | ApiSharedObjectfa4f19d7d0$Outbound
  | ApiProductUpdateRequest$Outbound;

/** @internal */
export const ApiProductUpdateRequestUnion$outboundSchema: z.ZodMiniType<
  ApiProductUpdateRequestUnion$Outbound,
  ApiProductUpdateRequestUnion
> = smartUnion([
  ApiSharedObjectfa4f19d7d0$outboundSchema,
  z.lazy(() => ApiProductUpdateRequest$outboundSchema),
]);

export function apiProductUpdateRequestUnionToJSON(
  apiProductUpdateRequestUnion: ApiProductUpdateRequestUnion,
): string {
  return JSON.stringify(
    ApiProductUpdateRequestUnion$outboundSchema.parse(
      apiProductUpdateRequestUnion,
    ),
  );
}
