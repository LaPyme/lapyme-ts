...
import {
  ...
  ApiSharedObjectdacb842378$inboundSchema,
} from "./api-shared-objectdacb842378.js";
import {
...
export type ApiSaleDetailResponseData = {
  ...
  document?: ApiSharedObjectdacb842378 | undefined;
...
> = z.pipe(
  z.catchall(
    z.object({
      ...
      document: types.optional(ApiSharedObjectdacb842378$inboundSchema),
