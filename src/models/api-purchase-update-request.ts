...
import {
  ...
  ApiSharedObjecta0d0e49f42$outboundSchema,
} from "./api-shared-objecta0d0e49f42.js";
import {
...
export type ApiPurchaseUpdateRequest = {
  ...
  items: Array<ApiSharedObjecta0d0e49f42>;
...
export type ApiPurchaseUpdateRequest$Outbound = {
  ...
  items: Array<ApiSharedObjecta0d0e49f42$Outbound>;
  subtotal?: number | undefined;
...
> = z.pipe(
  z.object({
    ...
    items: z.array(ApiSharedObjecta0d0e49f42$outboundSchema),
