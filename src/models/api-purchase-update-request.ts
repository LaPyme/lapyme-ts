...
import {
  ...
  ApiSharedObject65e544dba2$outboundSchema,
} from "./api-shared-object65e544dba2.js";
import {
...
export type ApiPurchaseUpdateRequest = {
  ...
  items: Array<ApiSharedObject65e544dba2>;
...
export type ApiPurchaseUpdateRequest$Outbound = {
  ...
  items: Array<ApiSharedObject65e544dba2$Outbound>;
  subtotal?: number | undefined;
...
> = z.pipe(
  z.object({
    ...
    items: z.array(ApiSharedObject65e544dba2$outboundSchema),
