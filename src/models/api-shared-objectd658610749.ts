...
export type ApiSharedObjectd658610749 = {
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObjectd658610749$inboundSchema: z.ZodMiniType<
...
export function apiSharedObjectd658610749FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObjectd658610749, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObjectd658610749$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObjectd658610749' from JSON`,
  );
}
