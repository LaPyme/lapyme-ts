...
export type ApiSharedObjectd835b52c6b = {
...
/** @internal */
export const ApiSharedObjectd835b52c6b$inboundSchema: z.ZodMiniType<
...
export function apiSharedObjectd835b52c6bFromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObjectd835b52c6b, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObjectd835b52c6b$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObjectd835b52c6b' from JSON`,
  );
}
