...
import {
  ...
  ApiSharedObject3b83f74923$inboundSchema,
} from "./api-shared-object3b83f74923.js";
import {
...
export type ApiSharedObject43abd4a8a1 = {
  id: string;
  name: string;
  ...
  createdAt: Date;
  updatedAt: Date;
  components: Array<ApiSharedObject564df4258f>;
  effectivePrice?: number | undefined;
  priceSource?: ApiSharedEnumfe93f70a59 | undefined;
  appliedPriceList?: ApiSharedObject3b83f74923 | undefined;
  object: "product";
...
/** @internal */
export const ApiSharedObject43abd4a8a1$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    components: z.array(ApiSharedObject564df4258f$inboundSchema),
    effective_price: types.optional(types.number()),
    price_source: types.optional(ApiSharedEnumfe93f70a59$inboundSchema),
    applied_price_list: types.optional(ApiSharedObject3b83f74923$inboundSchema),
...
export function apiSharedObject43abd4a8a1FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObject43abd4a8a1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObject43abd4a8a1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObject43abd4a8a1' from JSON`,
  );
}
