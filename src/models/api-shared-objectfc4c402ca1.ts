...
export type ApiSharedObjectfc4c402ca1 = {
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObjectfc4c402ca1$inboundSchema: z.ZodMiniType<
...
export function apiSharedObjectfc4c402ca1FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObjectfc4c402ca1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObjectfc4c402ca1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObjectfc4c402ca1' from JSON`,
  );
}
