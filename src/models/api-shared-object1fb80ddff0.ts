...
export type ApiSharedObject1fb80ddff0 = {
...
/** @internal */
export const ApiSharedObject1fb80ddff0$inboundSchema: z.ZodMiniType<
...
export function apiSharedObject1fb80ddff0FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObject1fb80ddff0, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObject1fb80ddff0$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObject1fb80ddff0' from JSON`,
  );
}
