...
export const InventoryEffect = {
  ...
  LegacyInconsistent: "legacy_inconsistent",
} as const;
export type InventoryEffect = OpenEnum<typeof InventoryEffect>;
...
export type ApiPurchaseDetail = {
   ...
   */
  document: ApiSharedObject9c9e4b0e0d;
  createdAt: Date;
...
/** @internal */
export const InventoryEffect$inboundSchema: z.ZodMiniType<
  InventoryEffect,
  unknown
> = openEnums.inboundSchema(InventoryEffect);
...
> = z.pipe(
  z.object({
    ...
    document: ApiSharedObject9c9e4b0e0d$inboundSchema,
    ...
    inventory_effect: InventoryEffect$inboundSchema,
