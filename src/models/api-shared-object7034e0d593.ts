...
export type ApiSharedObject7034e0d593 = {
  object: "supplier";
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObject7034e0d593$inboundSchema: z.ZodMiniType<
...
export function apiSharedObject7034e0d593FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObject7034e0d593, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObject7034e0d593$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObject7034e0d593' from JSON`,
  );
}
