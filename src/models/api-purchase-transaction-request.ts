...
export type ApiPurchaseTransactionRequest = {
  ...
  items?: Array<ApiSharedObjectd4b58bde30> | undefined;
...
export type ApiPurchaseTransactionRequest$Outbound = {
  ...
  items?: Array<ApiSharedObjectd4b58bde30$Outbound> | undefined;
  subtotal?: number | undefined;
...
> = z.pipe(
  z.object({
    ...
    items: z.optional(z.array(ApiSharedObjectd4b58bde30$outboundSchema)),
