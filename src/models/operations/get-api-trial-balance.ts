...
/** @internal */
export const GetApiTrialBalanceRequest$outboundSchema: z.ZodMiniType<
  GetApiTrialBalanceRequest$Outbound,
...
export function getApiTrialBalanceRequestToJSON(
  getApiTrialBalanceRequest: GetApiTrialBalanceRequest,
): string {
  return JSON.stringify(
    GetApiTrialBalanceRequest$outboundSchema.parse(getApiTrialBalanceRequest),
  );
}

/** @internal */
export const GetApiTrialBalanceResponse$inboundSchema: z.ZodMiniType<
  GetApiTrialBalanceResponse,
  unknown
> = z.pipe(
  z.object({
...
export function getApiTrialBalanceResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetApiTrialBalanceResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetApiTrialBalanceResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetApiTrialBalanceResponse' from JSON`,
  );
}
