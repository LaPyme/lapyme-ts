...
import {
  ApiSharedObject1fb80ddff0,
  ApiSharedObject1fb80ddff0$inboundSchema,
} from "./api-shared-object1fb80ddff0.js";
import {
...
export type NormalizedPurchase = {
  ...
  items: Array<ApiSharedObject1fb80ddff0>;
};
...
> = z.pipe(
  z.object({
    ...
    items: z.array(ApiSharedObject1fb80ddff0$inboundSchema),
  }),
  z.transform((v) => {
    return remap$(v, {
