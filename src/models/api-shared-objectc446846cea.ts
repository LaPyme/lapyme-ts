...
export type ApiSharedObjectc446846cea = {
  object: "customer";
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObjectc446846cea$inboundSchema: z.ZodMiniType<
...
export function apiSharedObjectc446846ceaFromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObjectc446846cea, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObjectc446846cea$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObjectc446846cea' from JSON`,
  );
}
