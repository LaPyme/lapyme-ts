...
export type ApiSharedObject36dfdd5b32 = {
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObject36dfdd5b32$inboundSchema: z.ZodMiniType<
...
export function apiSharedObject36dfdd5b32FromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObject36dfdd5b32, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObject36dfdd5b32$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObject36dfdd5b32' from JSON`,
  );
}
