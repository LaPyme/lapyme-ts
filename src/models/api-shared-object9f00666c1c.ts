...
export type ApiSharedObject9f00666c1c = {
  object: "customer";
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObject9f00666c1c$inboundSchema: z.ZodMiniType<
...
export function apiSharedObject9f00666c1cFromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObject9f00666c1c, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObject9f00666c1c$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObject9f00666c1c' from JSON`,
  );
}
