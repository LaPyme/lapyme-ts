...
export type ApiSharedObjectdf06cc06be = {
  object: "customer";
  id: string;
  name: string;
...
/** @internal */
export const ApiSharedObjectdf06cc06be$inboundSchema: z.ZodMiniType<
...
export function apiSharedObjectdf06cc06beFromJSON(
  jsonString: string,
): SafeParseResult<ApiSharedObjectdf06cc06be, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ApiSharedObjectdf06cc06be$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiSharedObjectdf06cc06be' from JSON`,
  );
}
